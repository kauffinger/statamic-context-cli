...
class StatamicContextSearchCommand extends Command
{
    ...
    private function displayHelp(DocumentationRepository $repository): void
    {
        ...
        $this->components->twoColumnDetail('<fg=gray>Pagination</>', 'php artisan statamic-context:docs:search [query] --start=10 --limit=10');
        ...
        $this->line('  php artisan statamic-context:docs:search blueprints --limit=20');
        $this->line('  php artisan statamic-context:docs:search "extend markdown" --start=10');
